(function (global, factory) {
    ...
    })(exports.EncodingKind || (exports.EncodingKind = {}));
    (function (SidebarKind) {
        SidebarKind["Preview"] = "tree";
        SidebarKind["Config"] = "config";
    })(exports.SidebarKind || (exports.SidebarKind = {}));
    (function (TargetKind) {
    ...
    function buildDynamicEmbedQueryString(options) {
        ...
        if (options.sidebar &&
            Object.values(exports.SidebarKind).indexOf(options.sidebar) === -1)
            throw new TypeError(`options.sidebar, if specified, must be one of the following values ${Object.values(exports.SidebarKind).join(', ')}`);
        const query = [];
    ...
    function validateProjectFile(projectFile) {
        ...
        if (projectFile.encoding &&
            !(projectFile.encoding === exports.EncodingKind.Base64 ||
                projectFile.encoding === exports.EncodingKind.Utf8))
            throw new TypeError(`projectSpec.files.pathname must be one of ${Object.values(exports.EncodingKind).join(', ')}`);
        ...
        return {
            ...
            encoding: projectFile.encoding || exports.EncodingKind.Utf8,
        };
    }
    function showDynamicEditor(projectSpec, options = {}) {
        ...
        if (options.target &&
            Object.values(exports.TargetKind).indexOf(options.target) === -1)
            throw new TypeError(`options.target, if specified, must be one of the following values ${Object.values(exports.TargetKind).join(', ')}`);
        if (options.parentEl &&
    ...
    exports.showDynamicEditor = showDynamicEditor;
    exports.showDynamicEmbed = showDynamicEmbed;
